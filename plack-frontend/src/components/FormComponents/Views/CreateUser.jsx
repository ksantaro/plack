  ...
  render() {
    return (
      <form className="form-container" onSubmit={this.props.onSubmit}>
        ...
        <FormInput placeholder="USERNAME" name="username" value={this.props.username} onChange={this.props.onChange} required/>
        <FormInput type="email" placeholder="EMAIL" name="email" value={this.props.email} onChange={this.props.onChange} required/>
